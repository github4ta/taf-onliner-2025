...
public class TasksPage {
    private final String SUBSECTION_NAME = "//a[text()='??????']/ancestor::div[@class='service-form__collapse-header']";
    ...
    private final String FIRST_ITEM_IN_SEARCH = "//*[@id=\"service-list\"]/div[2]/div/div/div[3]/search-tasks-list/div/div/div[1]/search-tasks-item/div/div/div[1]/div/a/span[2]/span[1]";
    private final String TITLE = "//*[@id=\"container\"]/div/div[2]/div/div/div/div/div/div[1]/div/div/div/div[1]/div";
    private final String SCROLL_TO_SECTION_TITLE = "//div[@class='service-form__label-title' and text()='??????']";
